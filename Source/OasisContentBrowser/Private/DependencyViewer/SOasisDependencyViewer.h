...
class UEdGraph;
class UEdGraph_OasisDependencyViewer;
 ...
 * 
 */
class SOasisDependencyViewer : public SCompoundWidget
{
public:
	SLATE_BEGIN_ARGS( SOasisDependencyViewer ){}

	SLATE_END_ARGS()

	~SOasisDependencyViewer();
...
private:
	...
	UEdGraph_OasisDependencyViewer* GraphObj;
