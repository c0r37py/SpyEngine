...
class SOasisBuildProgressWidget;

/**
 * A FFeedbackContext implementation for use in UnrealEd.
 */
class FOasisFeedbackContextEditor : public FFeedbackContext
{
	...
	TSharedPtr<class SOasisBuildProgressWidget> BuildProgressWidget;

	bool HasTaskBeenCancelled;

public:

	FOasisFeedbackContextEditor();
