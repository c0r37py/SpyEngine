...
namespace OasisContentBrowserUtils
{
	...
	void GetAssetsInPaths(const TArray<FString>& InPaths, TArray<FOasisAssetData>& OutAssetDataList);
	...
	void CopyFilePathsToClipboard(const TArray<FOasisAssetData>& AssetsToCopy);
