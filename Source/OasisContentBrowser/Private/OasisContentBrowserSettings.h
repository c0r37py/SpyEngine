...
#include "OasisContentBrowserSettings.generated.h"

/**
 * Implements external content browser settings.  These are global not per-project
 */
UCLASS(config=EditorSettings)
class UOasisContentBrowserSettings : public UObject
{
...
public:
	 ...
	 * @return The delegate.
	 */
	DECLARE_EVENT_OneParam(UOasisContentBrowserSettings, FSettingChangedEvent, FName /*PropertyName*/);
