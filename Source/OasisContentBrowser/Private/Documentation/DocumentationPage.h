...
class FOasisDocumentationPage : public IDocumentationPage
{
public:
...
public:
	...
	virtual ~FOasisDocumentationPage();
...
private:
	...
	FOasisDocumentationPage( const FString& InLink, const TSharedRef< FExtUDNParser >& InParser );
