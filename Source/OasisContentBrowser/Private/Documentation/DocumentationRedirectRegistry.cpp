...
bool FOasisDocumentationRedirectRegistry::Register(const FName& Owner, const FDocumentationRedirect& Redirect)
{
...
void FOasisDocumentationRedirectRegistry::UnregisterAll(const FName& Owner)
{
...
bool FOasisDocumentationRedirectRegistry::GetRedirect(const FString& Link, FDocumentationRedirect& OutRedirect) const
{
