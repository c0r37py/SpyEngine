 ...
 */
class SOasisFilterList : public SCompoundWidget
{
public:
	...
	SLATE_BEGIN_ARGS( SOasisFilterList ){}
	...
	void DisableFiltersThatHideAssets(const TArray<FOasisAssetData>& AssetDataList);
