...
class SOasisAssetViewItem : public SCompoundWidget
{
	friend class SOasisAssetViewItemToolTip;
...
public:
	...
	SLATE_BEGIN_ARGS( SOasisAssetViewItem )
...
class SExtAssetListItem : public SOasisAssetViewItem
{
...
class SExtAssetTileItem : public SOasisAssetViewItem
{
	friend struct FExtAssetViewItemHelper;
...
class SExtAssetColumnItem : public SOasisAssetViewItem
{
public:
