 ...
 */
class IOasisContentBrowserSingleton
{
public:
	/** Virtual destructor */
	virtual ~IOasisContentBrowserSingleton() {}
	...
	virtual void GetSelectedAssets(TArray<FOasisAssetData>& SelectedAssets) = 0;
	 ...
	 * @param bFocuSOasisContentBrowser          When true, brings the ContentBrowser into the foreground.
	 ...
	 */ 
	virtual void SyncBrowserToAssets(const TArray<struct FAssetData>& AssetDataList, bool bAllowLockedBrowsers = false, bool bFocuSOasisContentBrowser = true, const FName& InstanceName = FName(), bool bNewSpawnBrowser = false) = 0;
	 ...
	 * @param InstanceName					When supplied, will only sync the Content Browser with the matching InstanceName.  bAllowLockedBrowsers is ignored.
	 */ 
	virtual void SyncBrowserToAssets(const TArray<UObject*>& AssetList, bool bAllowLockedBrowsers = false, bool bFocuSOasisContentBrowser = true, const FName& InstanceName = FName(), bool bNewSpawnBrowser = false) = 0;
	 ...
	 */ 
	virtual void SyncBrowserToFolders(const TArray<FString>& FolderList, bool bAllowLockedBrowsers = false, bool bFocuSOasisContentBrowser = true, const FName& InstanceName = FName(), bool bNewSpawnBrowser = false) = 0;
	 ...
	 * @param bNewSpawnBrowser				When supplied, will spawn a new Content Browser instead of selecting the assets in an existing one.
	 */ 
	virtual void SyncBrowserTo(const FOasisContentBrowserSelection& ItemSelection, bool bAllowLockedBrowsers = false, bool bFocuSOasisContentBrowser = true, const FName& InstanceName = FName(), bool bNewSpawnBrowser = false) = 0;
