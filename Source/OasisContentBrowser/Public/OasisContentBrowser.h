...
DECLARE_MULTICAST_DELEGATE_TwoParams(FOnExtAssetSelectionChanged, const TArray<FOasisAssetData>& /*NewSelectedAssets*/, bool /*bIsPrimaryBrowser*/);

class FOasisContentBrowserModule : public IModuleInterface, public IDocumentationProvider
{
public:
	DECLARE_DELEGATE_RetVal(TSharedRef<FExtender>, FOasisContentBrowserMenuExtender);
...
public:
	...
	virtual IOasisContentBrowserSingleton& Get() const;

	virtual TArray<FOasisContentBrowserMenuExtender>& GetAllAssetViewViewMenuExtenders() { return AssetViewViewMenuExtenders; }
...
private:
	...
	IOasisContentBrowserSingleton* ContentBrowserSingleton;
	TArray<FOasisContentBrowserMenuExtender> AssetViewViewMenuExtenders;
